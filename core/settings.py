...
SECRET_KEY = 'django-insecure-p*7im19%bhszo)bl+pk(lf)_*w%o8@@t@-d63@7o&-y6owhz8c'
...
# Путь к медиафайлам (изображения товаров)
MEDIA_URL = '/media/'
...
# Настройка стилей для сообщений (уведомлений)
MESSAGE_TAGS = {
